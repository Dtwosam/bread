...
const CANONICAL_TOKEN_IMAGE_PATH =
  /^token-images\/[0-9a-f]{64}\/(?:card|detail)\.webp$/;
...
function trustedMediaReference(
  value: unknown,
  trustedMediaBaseUrl: string | undefined,
): string | undefined {
